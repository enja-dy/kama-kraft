        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
          ...
          >
            ...
            <section id="intro" className="space-y-6 scroll-mt-40">
              <h2 className="text-2xl font-bold tracking-tight text-foreground">はじめに</h2>
            ...
            <section id="purpose" className="space-y-6 scroll-mt-40">
              <h2 className="text-2xl font-bold tracking-tight text-foreground">情報の利用目的</h2>
              <ul className="space-y-4 text-foreground/80 font-medium text-sm md:text-base">
                {[
            ...
            <section id="third-party" className="space-y-6 scroll-mt-40">
              <div className="flex items-center gap-4 mb-8">
                 ...
                 <h2 className="text-2xl font-bold tracking-tight text-foreground">第三者への提供について</h2>
              </div>
              <div className="prose dark:prose-invert prose-base max-w-none text-foreground/80 leading-relaxed font-medium">
                <p>
            ...
            <section id="outsourcing" className="space-y-6 scroll-mt-40">
              <h2 className="text-2xl font-bold tracking-tight text-foreground">業務委託について</h2>
            ...
            <section id="cookies" className="space-y-6 scroll-mt-40">
              <div className="flex items-center gap-4 mb-4">
                 <MousePointer2 size={20} className="text-foreground/40" />
                 <h2 className="text-2xl font-bold tracking-tight text-foreground">Cookieの使用について</h2>
              </div>
              <div className="prose dark:prose-invert prose-base max-w-none text-foreground/80 leading-relaxed font-medium">
                <p>
            ...
            <section id="rights" className="space-y-6 scroll-mt-40">
              <h2 className="text-2xl font-bold tracking-tight text-foreground">権利の尊重</h2>
              <div className="prose dark:prose-invert prose-base max-w-none text-foreground/80 leading-relaxed font-medium">
                <p>
            ...
            <section id="changes" className="space-y-6 scroll-mt-40">
              <div className="flex items-center gap-4 mb-4">
                 <RefreshCw size={20} className="text-foreground/40 animate-spin-slow" />
                 <h2 className="text-2xl font-bold tracking-tight text-foreground">ポリシーの変更</h2>
              </div>
              <div className="prose dark:prose-invert prose-base max-w-none text-foreground/80 leading-relaxed font-medium">
                <p>
            ...
            <section id="contact" className="space-y-6 scroll-mt-40">
              <h2 className="text-2xl font-bold tracking-tight text-foreground">お問い合わせ窓口</h2>
