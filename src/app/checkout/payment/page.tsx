            ...
            <div className="space-y-10">
              ...
              <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <button className="flex items-center justify-center gap-3 bg-white border border-foreground/10 p-5 rounded-2xl hover:bg-foreground/[0.02] transition-all font-bold text-black">
                    <Image src="https://upload.wikimedia.org/wikipedia/commons/5/53/Google_Pay_Logo.svg" alt="Google Pay" width={60} height={24} className="h-6" />
                  </button>
                </div>
              </section>
