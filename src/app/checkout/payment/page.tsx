              ...
              <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <button className="flex items-center justify-center gap-3 bg-white border border-foreground/10 p-5 rounded-2xl hover:bg-foreground/[0.02] transition-all font-bold text-black group">
                    <svg width="60" height="24" viewBox="0 0 41 17" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6">
                      <path d="M18.5 13.514V3.122h3.402c.812 0 1.503.178 2.072.532a3.425 3.425 0 011.4 1.503c.335.584.502 1.259.502 2.025 0 .767-.167 1.442-.502 2.026a3.425 3.425 0 01-1.4 1.503c-.569.354-1.26.532-2.072.532h-3.402zm1.26-1.144h2.142c.579 0 1.055-.133 1.43-.399a2.38 2.38 0 00.916-1.127c.214-.485.32-.a3.02 3.02 0 000-2.31c-.106-.239-.247-.452-.421-.638a2.3 2.3 0 00-.495-.44 2.145 2.145 0 00-.596-.285 3.52 3.52 0 00-.834-.096h-2.142v6.495zm7.348-.137a3.078 3.078 0 01-.444-.81c-.116-.31-.174-.638-.174-.984V7.55c0-.62-.164-1.1-.494-1.443-.33-.343-.787-.514-1.371-.514-.44 0-.834.116-1.181.348-.348.232-.61.54-.787.925v3.535l-1.264.004V5.7h1.163l.078.783c.27-.31.597-.56.983-.751a2.809 2.809 0 011.36-.286c.924 0 1.638.28 2.14.838.502.558.753 1.343.753 2.353v3.744h-1.263l.004-.004zm6.052-1.25l-.01.522c-.255.27-.55.48-.887.632a3.41 3.41 0 01-1.295.228c-.808 0-1.464-.23-1.968-.69-.504-.46-.756-1.114-.756-1.96 0-.853.27-1.513.811-1.982.54-.468 1.25-.702 2.126-.702.433 0 .808.064 1.125.192.317.128.591.298.823.51l-.733.815a2.539 2.539 0 00-.555-.33c-.201-.088-.415-.132-.64-.132-.444 0-.802.13-1.074.39-.271.26-.407.632-.407 1.116 0 .502.131.884.393 1.144.262.261.61.391 1.045.391.444 0 .783-.179 1.017-.537l-.014-.407h-.988v-.95h2.01zm5.2 0l-.01.522c-.255.27-.55.48-.887.632a3.41 3.41 0 01-1.295.228c-.808 0-1.464-.23-1.968-.69-.504-.46-.756-1.114-.756-1.96 0-.853.27-1.513.811-1.982.54-.468 1.25-.702 2.126-.702.433 0 .808.064 1.125.192.317.128.591.298.823.51l-.733.815a2.539 2.539 0 00-.555-.33c-.201-.088-.415-.132-.64-.132-.444 0-.802.13-1.074.39-.271.26-.407.632-.407 1.116 0 .502.131.884.393 1.144.262.261.61.391 1.045.391.444 0 .783-.179 1.017-.537l-.014-.407h-.988v-.95h2.01z" fill="#5F6368"/>
                      <path d="M7.74 3.707c0-.256-.023-.51-.068-.76H4v1.514h2.12c-.092.493-.37 0 .918.736l-1.482.99s.816.612 1.482.99c.39-.364.693-.815.885-1.325.19-.508.286-1.054.286-1.605z" fill="#4285F4"/>
                      <path d="M4 7.5c.9 0 1.758-.332 2.42-.93l-1.482-.99c-.273.184-.596.286-.938.286-1.054 0-1.944-.712-2.263-1.666H.22v1.178C.78 6.44 2.308 7.5 4 7.5z" fill="#34A853"/>
                      <path d="M1.737 4.2c-.08-.242-.122-.5-.122-.77 0-.25.042-.5.122-.73V1.522H.22A3.996 3.996 0 000 3.43c0 .668.167 1.322.486 1.905l1.251-1.135z" fill="#FBBC05"/>
                      <path d="M4 .866c.55 0 1.05.19 1.442.56L6.5 .366A3.993 3.993 0 004 0C2.308 0 .78 1.06.22 2.222l1.517 1.178C2.056 2.446 2.946 1.734 4 1.734c-.001 0-.001.001 0 .001l-.001-.869z" fill="#EA4335"/>
                    </svg>
                  </button>
                </div>
              </section>
