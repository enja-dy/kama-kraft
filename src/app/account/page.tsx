              ...
              <div className="space-y-6 text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="relative">
                      ...
                      {isLoadingAddress && (
                        <div className="absolute right-3 top-1/2 -translate-y-1/2">
                          <motion.div animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 1, ease: "linear" }} className="w-4 h-4 border-2 border-foreground border-t-transparent rounded-full" />
                        </div>
                      )}
                      {!isLoadingAddress && newZip.length === 7 && (
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-[10px] font-bold tracking-[0.2em] text-foreground/60 uppercase mb-2">都道府県</label>
                    <input 
                      type="text" 
                      value={newPrefecture}
                ...
                <div>
                  <label className="block text-[10px] font-bold tracking-[0.2em] text-foreground/60 uppercase mb-2">市区町村・番地</label>
                  <input 
                    type="text" 
                    value={newAddress}
                ...
                <div>
                  <label className="block text-[10px] font-bold tracking-[0.2em] text-foreground/60 uppercase mb-2">建物名・部屋番号（任意）</label>
                  <input 
                    type="text" 
                    value={newBuilding}
