...
KamaKraftは、この活気に満ちた「生命のプロセス」を、お客様が心から楽しめるよう、確かな知識と技術でサポートし続けます。`,
  ...
  "borneo-ulin-asset-value": {
    slug: "borneo-ulin-asset-value",
    title: "ボルネオ産「本ウリン」の資産価値と、\n一生モノの家具を選ぶ意義",
    titleEn: "The Eternal Heritage",
    subtitle: "「消費」から「継承」へ。最強の木材が紡ぐ、家族の100年物語",
    heroImage: "/journal/07-asset-value/ulin-standing-heritage.png",
    publishDate: "2026.04.01",
    category: "ウリン豆知識",
    introTitle: "その一脚は、100年後の家族に何を語りかけるだろうか。",
    introContent: `私たちは、あまりにも早く「物」が使い捨てられる時代に生きています。安価な素材で作られ、数年でガタが来れば買い換える。それが当たり前の風景となりました。しかし、そのサイクルの中で、私たちは何か大切な「記憶の蓄積」を失ってはいないでしょうか。

ボルネオの原生林で数百年の歳月をかけて育まれた「ウリン（アイアンウッド）」。この木を家具として迎え入れることは、単なる買い物ではありません。それは、自然界が長い時間をかけて作り上げた究極の機能美を、自らの邸宅へと「継承」する行為です。

今回は、なぜウリンが世界で最も「資産価値」の高い木材の一つと見なされるのか。そして、一生モノの家具を選ぶことが、あなたの人生と、次世代の環境にどのような豊かさをもたらすのかを、深く考察します。`,
    sections: [
      {
        title: "大自然が数世紀を費やした、\n「非代替的」な希少性",
        content: `ウリンが「資産」と呼ばれる最大の理由は、その再生に要する時間の長さにあります。一般的な商業木材が数十年で成長するのに対し、ウリンが大径木として家具の材料に耐えうるサイズになるまでには、300年から500年という、人間の一生を遥かに超える歳月が必要です。

現在、ボルネオ島でもウリンの伐採や輸出には極めて厳しい制限がかけられています。つまり、私たちが今手にすることができる「本ウリン」は、地球上に限られた量しか存在しない、極めて希少な天然資源なのです。

この「時間の結晶」を所有することは、もはや金や宝石を所有することに近い意味を持ちます。市場での価値が落ちにくいだけでなく、その存在自体が、もはや現代では二度と作り出せない「歴史の一部」を手にすることを意味しているのです。`,
        icon: Sparkles,
        items: [
          { icon: ShieldCheck, text: "供給制限により、今後さらに希少性が高まることが予想される希少木材。" },
          { icon: Hourglass, text: "数世紀の歳月が凝縮された超高密度な細胞組織が、唯一無二の価値を生む。" }
        ]
      },
      {
        title: "「目減りしない」という、\n物理的な信頼",
        content: `多くの資産は、時の経過とともに劣化し、価値を減らしていきます。しかし、ウリンはその強靭な物理的特性により、劣化という概念を拒絶します。

雨に打たれ、日光に晒されても、芯まで腐食することはありません。もし表面が古びたとしても、今回掲載したディテール画像のように、職人が薄くサンディング（研磨）を施せば、数十年後でも施工時と変わらない、あの瑞々しく深い赤褐色が再び顔を出します。

この「何度でも再生できる」という特性は、素材としての価値を永続させるための最強の武器です。建物が寿命を迎え、取り壊されることがあっても、ウリンの家具やデッキ材だけは健全なまま残り、また新しい場所で役割を果たすことができる。この「不朽性」こそが、実利的な資産価値の源泉です。`,
        image: "/journal/07-asset-value/content-1.png",
        imageAlt: "Detailed Ulin furniture joinery with a hand touching the surface",
        icon: Wand2
      },
      {
        type: "cards",
        title: "一生モノを選ぶ、３つの精神的意義",
        subtitle: "The Philosophy of One-Time Choice",
        cards: [
          { 
            icon: History, 
            title: "家族の記憶を\n刻む「器」", 
            text: "傷も、色の変化も、すべてが家族の歴史。買い換えないからこそ、その家具には言葉以上の物語が蓄積されていきます。" 
          },
          { 
            icon: Shield, 
            title: "「選ぶ疲れ」からの\n解放", 
            text: "最高峰のものを一度選ぶことで、その後の「どれが良いか」という悩みから一生解放されます。思考を重要なことに集中させるための贅沢です。" 
          }
        ]
      },
      {
        title: "未来への責任：\nサステナビリティの極致",
        content: `「良いものを長く使う」ことは、現代において最も誠実な環境保護活動です。

10年でゴミになる家具を5回買い換えるよりも、100年使い続けられるウリンの家具を1台選ぶ方が、結果として森林資源の消費を劇的に抑えることができます。KamaKraftが提案するのは、使い捨ての連鎖を断ち切り、自然からの預かり物である木材を、責任を持って最後まで使い抜くというライフスタイルです。
...
それは、自分たちの世代だけでなく、まだ見ぬ100年後の子孫たちへ、「本物の質感」という財産を美しく残すことでもあるのです。`,
      ...
      {
        title: "結び：KamaKraftが、\nあなたの「100年物語」を支えます",
        content: `ウリンという木材が、いかに過酷な環境で生き抜き、いかに驚異的な強さを持ち、そしていかに豊かなエイジングを見せるか。その深遠な魅力を知ることは、お客様がこれから歩む「ウリンのある暮らし」をより豊かなものにするための第一歩です。

私たちが作る家具は、工場で量産される製品ではありません。ボルネオの森の記憶を、鎌倉の地で最高峰の工芸へと昇華させた「一生のパートナー」です。この記事を通じて、あなたが選ぶ一脚が、家族にとって代えがたい「遺産（ヘリテージ）」となり、共に時を刻み続けることを願っています。`,
        icon: History
      }
    ]
  }
