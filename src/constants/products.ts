...
export const products: Product[] = [
  ...
  },
  {
    ...
    story: {
      title: "どこにでも置ける、最高峰の贅沢。",
      titleItalic: "空間を広げる、コンパクトな重厚。",
      paragraphs: [
        "幅60cm。そのコンパクトなサイズに、アイアンウッド「ウリン」の圧倒的な品格を凝縮しました。大きな家具を置くことが難しい場所でも、この一脚があれば、そこはたちまち職人の手仕事が息づく特別な空間へと変わります。",
