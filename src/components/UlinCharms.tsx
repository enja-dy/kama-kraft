...
const charms = [
  {
    title: "圧倒的な耐久性",
    description: "「鉄の木 / アイアンウッド」と呼ばれるウリンは、世界で最も重厚かつ屈強な木材の一つです。その最大の特徴は、一般的な木材とは一線を画す驚異的な密度にあります。水に沈むほど重く、腐食を寄せ付けない天然の「ポリフェノール」を豊富に含んでいます。「100年以上腐らない」という伝説は、過酷な環境に耐え抜いてきた科学的な裏付けに基づいています。KamaKraftはこのウリンの生命力をそのままに、世代を超えて受け継がれる資産としての家具を追求しました。堅牢さはそのまま安心感へと繋がり、家族の歴史を刻む揺るぎない土台となります。一生モノという贅沢。それは単なる家具の枠を超えた、時の試練に耐えうる価値の象徴です。",
