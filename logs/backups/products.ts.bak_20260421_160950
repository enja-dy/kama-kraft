...
export const products: Product[] = [
  ...
  },
  {
    ...
    story: {
      title: "静謐に、鋭いリズムを。",
      titleItalic: "空間を研ぎ澄ます、最小の重厚。",
      paragraphs: [
        "鉄の木、ウリン。その圧倒的な密度と不朽の強度はそのままに、よりパーソナルな空間へと凝縮したのがこの一脚です。鎌倉の職人が、選び抜かれたアイアンウッドに新たな命を吹き込み、精緻な手仕事でモダンなシルエットへと昇華させました。",
        "サイドテーブルとして、あるいはエントランスを彩る花台として。コンパクトなサイズ感は、場所を選ばず「一点の贅」を添える自由を可能にします。重厚なるウリンが、限られた空間に確かな存在感を宿し、日常の何気ない風景を、格調高い時間へと変えていきます。",
        "知性を感じさせるV字脚は、物理的な安定と視覚的な軽やかさを両立。重厚な天板を確実に保持しながら、空間に心地よいリズムを刻みます。数十年、あるいは一世紀という時間を共にするための耐候性は、すでにこの木材の中に宿っています。手入れ不要の強さを、その手に。"
      ]
    },
    artisan: {
      name: "KamaKraft",
